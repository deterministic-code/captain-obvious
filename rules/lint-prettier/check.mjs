...
const USAGE = `Usage:
  node rules/lint-prettier/check.mjs --staged
  node rules/lint-prettier/check.mjs --all
  node rules/lint-prettier/check.mjs --files <path> [...]
  node rules/lint-prettier/check.mjs [--staged|--all] --warn
  node rules/lint-prettier/check.mjs --fix [--staged|--all|--files <path> ...]
`;
